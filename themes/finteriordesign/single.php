...
<div id="main-content-wrapper">
	...
	<?php if (have_posts()) :
			...
			while (have_posts()) :
				...
				wp_link_pages( array(
					'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'finteriordesign' ) . '</span>',
					'after'       => '</div>',
					'link_before' => '<span>',
					'link_after'  => '</span>',
				) );
				...
				the_post_navigation( array(
                    'prev_text' => __( 'Prev Chapter: %title', 'finteriordesign' ),
                    'next_text' => __( 'Next Chapter: %title', 'finteriordesign' ),
                ) );
